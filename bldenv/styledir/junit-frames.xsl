<!--
	This is the a supporting ant junitreport task that has been modified
        to display a link to stdout/stderr files.

	This is from Ant version 1.4.1.  The original file is located in
        optional.jar.
-->
...
pre {
	font:normal 125% verdana,arial,helvetica
}
.Error {
      ...
      <script language="JavaScript">
       ...
       <script language="JavaScript"><![CDATA[
		...
		<body>
			...
			<h3>Test <xsl:if test="not($package.name = '')"> <xsl:value-of select="$package.name"/>.</xsl:if><xsl:value-of select="@name"/></h3>
...
<xsl:template name="testsuite.stdout">
	.......(<A HREF="{@name}.out.html">stdout/stderr</A>)
</xsl:template>

<xsl:template name="testmethod.stdout">
	.......(<A HREF="{@test}.out.html#{@name}">stdout/stderr</A>)
</xsl:template>
...
<xsl:template match="testsuite" mode="print.test">
	<tr valign="top">		
		...
		<td><a href="{@name}.html"><xsl:value-of select="@name"/></a>
		    <xsl:call-template name="testsuite.stdout"/>
                </td>
