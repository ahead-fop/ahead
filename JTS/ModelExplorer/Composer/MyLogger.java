...
final public class MyLogger implements BuildLogger {
    /** 
     ...
     * Sole constructor.
     */
    public MyLogger(JTextArea outputArea) {
     ...
     * <code>MSG_DEBUG</code>.
     * <P>
     * The default message level for MyLogger is Project.MSG_ERR.
     * 
    ...
    public void setErrorPrintStream(PrintStream err) {
	 ...
	 /** sets the output area in the tools panel
	  */
