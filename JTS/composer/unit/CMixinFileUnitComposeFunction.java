...
// same as MixinFileUnitComposeFunction, except calls mixin with -c option.
//

class CMixinFileUnitComposeFunction extends FileUnitComposeFunction {

    public CMixinFileUnitComposeFunction (Factory fact, List src, Class klass) {
	...
	args.add ("-c") ;  // to copy files when there is no refinement
    ...
    CMixinFileUnitComposeFunction (Factory factory, List sources) {
	this (factory, sources, CMixinFileUnit.class) ;
    }
