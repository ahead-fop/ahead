...
public class SeeTagJTS extends TagJTS implements SeeTag {
	 ...
	 */
	public void setReferencedClass(ClassDoc _referencedClass)
	{
	...
	{
	  referencedClass = new DOCLETJTS.Lang.ClassDocJTS(referenceClassName);
	}
	...
	public void setReferencedMemberName(String referenceMemberName)
	{
		...
		// referencedMember = new MemberDocJTS(referenceMemberName);
	}
	 ...
	 */
	public void setReferencedPackage(PackageDoc _referencedPackage, 
									 String packageName)
	{
