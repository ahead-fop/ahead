...
class JamPackFileUnitComposeFunction extends FileUnitComposeFunction {

    public JamPackFileUnitComposeFunction
    ...
    JamPackFileUnitComposeFunction (Factory factory, List sources) {
	this (factory, sources, JamPackFileUnit.class) ;
    }
