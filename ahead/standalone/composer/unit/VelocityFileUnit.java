...
class VelocityFileUnit extends AdjoinFileUnit {

    public VelocityFileUnit (Factory factory, File file, Type type) {
	super (factory, file, type) ;
    }

    public static Function composeFunction (Factory factory, List sources) {
	return new VelocityFileUnitComposeFunction (factory, sources) ;
    }
