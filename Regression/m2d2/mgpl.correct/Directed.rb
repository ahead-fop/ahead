...
layer = JavaM::Layer.new(:name => 'Directed', :identifier => 'layer') 
package_used = JavaM::Package.new(:name => 'used', :identifier => 'used', :ownerLayer => layer)
package_feature = JavaM::Package.new(:name => 'Directed', :identifier => 'feature', , :ownerLayer => layer)
...
field_feature_Graph_isDirected = JavaM::Field.new(:name => 'feature.Graph.isDirected', :identifier => 'feature.Graph.isDirected', :type => primitiveType_boolean, :visibility => 'public', :nesting => 0, :isStatic => true, :isFinal => true, :ownerClass => feature_Graph, :value => ' = true')
