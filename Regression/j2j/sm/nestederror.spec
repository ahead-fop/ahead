State_machine nestederror extends class wrffe {
   ...
   condition m.msg == M.one do { /* m1Transition-action */; }

   Transition m2 : common -> m2
   condition m.msg == M.four do { /* m2Transition-action */; }

   Transition t3 : m1 -> three
   condition m.msg == M.three do { /* t3Transition-action */; }

   Transition t4 : three -> common
   condition m.msg == M.toc do { /* t4Transition-action */; }

   Transition tc : m1 -> common
   condition m.msg == M.toc  do { /* tcTransition-action */; }

   Transition tc1 : m2 -> common
   condition m.msg == M.toc  do { /* tc1Transition-action */; }

   Transition end : common -> stop
   condition m.msg == M.eom do { /* endTransition-action */; }
...
State_machine m2sm extends class wrffe {
   ...
   Transition t21 : start -> start condition m.msg == M.four do { outstate("M2"); }

   Transition t22 : start -> stop condition m.msg == M.toc do { outstate("M2"); }
}
