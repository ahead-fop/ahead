...
SoUrCe RooT Undirected "../GEN/Undirected/Graph.java";
...
SoUrCe  BFS "../GEN/BFS/Graph.java";

abstract
 class Graph$$BFS extends Graph$$Undirected {
...
SoUrCe  Number "../GEN/Number/Graph.java";

abstract class Graph$$Number extends Graph$$BFS {
...
SoUrCe  Benchmark "../GEN/Benchmark/Graph.java";

public
 class Graph extends Graph$$Number {
