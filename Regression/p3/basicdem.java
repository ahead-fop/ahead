...
class basicdem {
   ...
   public static void main( String args[] ) {
      ...
      empdem[] rawdata = {
                         new empdem( 10000,60,"Biology","Akers, Mark" ),
                         new empdem( 10070,22,"CompSci","Andrews, Kay" ),
                         new empdem( 10020,21,"Biology","Alexander, Joe" ),
                         new empdem( 10010,40,"Physics","Akin, Monica" ),
                         new empdem( 10050,42,"Biology","Akerson, Suzanne" ),
                         new empdem( 10040,53,"Astrono","Akerson, Mary" ),
                         new empdem( 10060,61,"CompSci","Andrews, John" ),
                         new empdem( 10030,23,"Biology","Akerson, Gwyn" )
                      };
      int i;
