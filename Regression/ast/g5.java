...
// it also tests the mth{ ... }mth constructor and the $mth() escape.
...
class g5 {
   ...
   AST_FieldDecl mth =(AST_FieldDecl) AstNode.markStack(AstNode.aliasStack.size(),  (AST_FieldDecl) new AST_FieldDecl()
...
.add( (AST_ModifiersElem) new AST_ModifiersElem().setParms( (ModPublic) new ModPublic().setParms( 
new AstToken().setParms("      //<-------- fill in methods here\n\n   // here's where the real work is done\n\n   ","public", 0)) /* ModPublic */
))/* AST_ModifiersElem + add */
