...
// and the mod{ ... }mod constructor and the $mod() escape
...
class g11 {
   ...
   AST_Modifiers  mod =(AST_Modifiers) AstNode.markStack(AstNode.aliasStack.size(),  (AST_Modifiers) new AST_Modifiers()
