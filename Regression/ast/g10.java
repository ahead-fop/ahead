...
// and the xlst{ ... }xlst constructor and $xlst() escape
...
class g10 {
   ...
   AST_ArgList xlst =(AST_ArgList) AstNode.markStack(AstNode.aliasStack.size(),  (AST_ArgList) new AST_ArgList()
...
.add( (AST_ArgList) AstNode.addComment( AstNode.safeCopy(xlst),"")) 
) /* AstOptNode */
, new AstToken().setParms("",")", 0)) /* Args */
,  new AstOptNode(
) /* AstOptNode */
