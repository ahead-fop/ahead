...
// and the typ{ ... }typ and $typ() escape
...
class g7 {
   ...
   AST_TypeName typ =(AST_TypeName) AstNode.markStack(AstNode.aliasStack.size(),  (PrimType) new PrimType().setParms( 
...
, (AST_TypeName) AstNode.addComment( AstNode.safeCopy(typ)," "),  (MthDector) new MthDector().setParms( 
