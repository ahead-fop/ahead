...
class g3 {
   ...
   AST_Exp exp =(AST_Exp) AstNode.markStack(AstNode.aliasStack.size(),  (EqExpr) new EqExpr().setParms( 
...
new AstToken().setParms("\n      ","if", 0), new AstToken().setParms(" ","(", 0), (ExprPre) new ExprPre().setParms( new AstToken().setParms(" ","(", 0),
(Expression) AstNode.addComment( AstNode.safeCopy(exp),""), new AstToken().setParms("",")", 0))
