...
class g13 {
   ...
   AST_VarInit vi =(AST_VarInit) AstNode.markStack(AstNode.aliasStack.size(),  (VarInitExpr) new VarInitExpr().setParms( 
...
new AstToken().setParms(" ","=", 0), (AST_VarInit) AstNode.addComment( AstNode.safeCopy(vi)," ")) /* VarAssignC */
) /* AstOptNode */
) /* VarDecl */
))/* AST_VarDeclElem + add */
) /* LocalVarDecl */
