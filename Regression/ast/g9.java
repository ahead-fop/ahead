...
// and the plst{ ... }plst constructor and the $plst() escape
...
class g9 {
   ...
   AST_ParList plst =(AST_ParList) AstNode.markStack(AstNode.aliasStack.size(),  (AST_ParList) new AST_ParList()
...
.add( (AST_ParList) AstNode.addComment( AstNode.safeCopy(plst)," ")) 
) /* AstOptNode */
, new AstToken().setParms(" ",")", 0),  new AstOptNode(
) /* AstOptNode */
) /* MthDector */
