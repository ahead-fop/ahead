...
// and the imp{ ...  }imp AST constructor and the $imp() escape
...
class g2 {
   ...
   AST_Imports imp =(AST_Imports) AstNode.markStack(AstNode.aliasStack.size(),  (AST_Imports) new AST_Imports()
...
.add( (AST_Imports) AstNode.addComment( AstNode.safeCopy(imp)," \n//------------------------------------------\n\n")) 
) /* AstOptNode */
,  new AstOptNode(
